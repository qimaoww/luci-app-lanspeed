...
try {
  const required = [
    ...
    'net/lanspeedd/rust/crates/lanspeedd/src/platform/x86/proxy_connections/mod.rs',
    'net/lanspeedd/rust/crates/lanspeedd/src/platform/x86/proxy_connections/mihomo.rs',
    'net/lanspeedd/rust/crates/lanspeedd/src/platform/x86/proxy_connections/dae.rs',
    'net/lanspeedd/rust/crates/lanspeedd/src/platform/x86/proxy_connections/http.rs',
  ...
  const bpfRuntime = fs.readFileSync(
    path.join(lanspeeddRoot, 'rust/crates/lanspeedd/src/platform/tc_bpf_runtime.rs'),
    'utf8'
  );
  assert(
