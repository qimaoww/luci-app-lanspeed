...
assert(schema.$defs.collectorMode.enum.includes('nss_ecm_node'), 'schema must allow status.collector_mode=nss_ecm_node');
assert(schema.$defs.collectorMode.enum.includes('nss_ecm_bpf'), 'schema must allow status.collector_mode=nss_ecm_bpf');
assert(!schema.$defs.collectorMode.enum.includes('nss_ecm_direct'), 'schema must remove legacy status.collector_mode=nss_ecm_direct');
...
assert(!schema.$defs.clients.properties.conn_source.enum.includes('nss_ecm_node'), 'conn_source must remain connection metadata, not the ECM rate source');
