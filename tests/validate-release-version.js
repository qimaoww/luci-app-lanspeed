...
try {
  ...
  assert(readme.includes('`1.1.4-r1`'), 'README full-version example must match the 1.1.4 release');
	assert(!/1\.1\.4-r(?:[02-9]|[1-9][0-9]+)/.test(readme),
	  'README must keep the 1.1.4 release at r1');
