...
pub struct RuntimeHealth {
    ...
    pub bpf_map_entries: usize,
    pub bpf_map_capacity: usize,
    pub bpf_map_iteration_truncated: bool,
    ...
    pub ecm_bpf_map_capacity: usize,
    ...
    pub ecm_bpf_event_coalesced: u64,
    pub ecm_bpf_event_invalid: u64,
    pub ecm_bpf_event_source_counts: [u64; 5],
    pub ecm_bpf_event_interval_histogram: [u64; 5],
    pub ecm_bpf_event_last_timestamp_ns: Option<u64>,
    pub ecm_bpf_event_last_sequence: Option<u64>,
    pub ecm_bpf_event_last_age_ms: Option<u64>,
...
impl Default for RuntimeHealth {
    fn default() -> Self {
        Self {
            ...
            bpf_map_entries: 0,
            bpf_map_capacity: 0,
            bpf_map_iteration_truncated: false,
            ...
            ecm_bpf_event_coalesced: 0,
            ecm_bpf_event_invalid: 0,
            ecm_bpf_event_source_counts: [0; 5],
            ecm_bpf_event_interval_histogram: [0; 5],
            ecm_bpf_event_last_timestamp_ns: None,
            ecm_bpf_event_last_sequence: None,
            ecm_bpf_event_last_age_ms: None,
            ecm_bpf_layout: None,
