...
pub(crate) fn apply_ecm_bpf_evidence(
    ...
    let mut ecm_bpf_details = json!({
            ...
            "event_hint": {
                ...
                "coalesced": runtime.ecm_bpf_event_coalesced,
                "invalid": runtime.ecm_bpf_event_invalid,
                "source_counts": {
                    "unknown": runtime.ecm_bpf_event_source_counts[0],
                    "sync_many_v4": runtime.ecm_bpf_event_source_counts[1],
                    "sync_many_v6": runtime.ecm_bpf_event_source_counts[2],
                    "netdev_v4": runtime.ecm_bpf_event_source_counts[3],
                    "netdev_v6": runtime.ecm_bpf_event_source_counts[4],
                },
                "interval_histogram_ms": {
                    "0_250": runtime.ecm_bpf_event_interval_histogram[0],
                    "251_500": runtime.ecm_bpf_event_interval_histogram[1],
                    "501_1000": runtime.ecm_bpf_event_interval_histogram[2],
                    "1001_2000": runtime.ecm_bpf_event_interval_histogram[3],
                    "over_2000": runtime.ecm_bpf_event_interval_histogram[4],
                },
                "last_timestamp_ns": runtime.ecm_bpf_event_last_timestamp_ns,
                "last_sequence": runtime.ecm_bpf_event_last_sequence,
                "last_age_ms": runtime.ecm_bpf_event_last_age_ms,
