...
var CONFIG_CSS = [
	...
	/* Argon-specific layout pass.  Argon already supplies white/dark
	   cards, button colour and shadow; these rules tune LAN Speed's
	   tables and inline editors to its side-nav content width. */
	...
	'.lanspeed-theme-argon .lanspeed-config-table td,',
	'.lanspeed-theme-argon .lanspeed-ifcfg-table th,',
	'.lanspeed-theme-argon .lanspeed-ifcfg-table td{padding:.6rem .65rem}',
	'.lanspeed-theme-argon .lanspeed-config-table th:first-child,',
	'.lanspeed-theme-argon .lanspeed-config-table td:first-child,',
	'.lanspeed-theme-argon .lanspeed-ifcfg-table th:first-child,',
	'.lanspeed-theme-argon .lanspeed-ifcfg-table td:first-child{padding-left:0}',
	...
	'.lanspeed-theme-argon .lanspeed-config-table td:nth-child(2){width:13rem}',
	'.lanspeed-theme-argon .lanspeed-config-table th:nth-child(3),',
	'.lanspeed-theme-argon .lanspeed-config-table td:nth-child(3){width:18rem}',
	...
	'.lanspeed-theme-argon .lanspeed-ifcfg-seg>button{padding:.5rem .7rem;border-radius:.25rem}',
