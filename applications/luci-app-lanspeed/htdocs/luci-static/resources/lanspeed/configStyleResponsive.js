...
var RESPONSIVE_CSS = [
	...
	'  box-sizing:border-box;overflow-x:hidden}',
	ROOT_SCOPE + ' .lanspeed-config-groups{width:100%;min-width:0;max-width:100%;box-sizing:border-box}',
	ROOT_SCOPE + ' .lanspeed-config-list{width:100%;min-width:0;max-width:100%;box-sizing:border-box}',
	ROOT_SCOPE + ' .lanspeed-config-compact-field{grid-template-columns:minmax(0,1fr);gap:.2rem;',
	'  align-items:start;width:100%;min-width:0;max-width:100%;box-sizing:border-box;padding:.5rem .65rem}',
	ROOT_SCOPE + ' .lanspeed-config-field-label,',
	ROOT_SCOPE + ' .lanspeed-config-field-control,',
	ROOT_SCOPE + ' .lanspeed-config-field-hint{width:100%;max-width:100%;box-sizing:border-box}',
	ROOT_SCOPE + ' .lanspeed-config-field-control.value :is(input:not([type="checkbox"]):not([type="radio"]),select){',
