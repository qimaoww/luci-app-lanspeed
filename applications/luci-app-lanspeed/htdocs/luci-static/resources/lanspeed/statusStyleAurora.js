...
var AURORA_CSS = [
	...
	'.lanspeed-theme-aurora .lanspeed-diagnostic-card{padding-top:.15rem;padding-bottom:.15rem}',
	'.lanspeed-theme-aurora .lanspeed-diagnostic-alert,',
	'.lanspeed-theme-aurora .lanspeed-diagnostic-alert-empty{border-radius:.75rem}',
	'.lanspeed-theme-aurora .lanspeed-warnings{display:grid;',
	'  grid-template-columns:max-content minmax(0,1fr);align-items:center;',
	'  column-gap:.5rem;row-gap:.25rem;padding-left:0}',
	'.lanspeed-theme-aurora .lanspeed-warnings li{display:contents}',
	'.lanspeed-theme-aurora .lanspeed-warnings li .key{margin-right:0;justify-self:start}',
	...
	'@media (max-width:767px){.lanspeed-theme-aurora .lanspeed-warnings{grid-template-columns:minmax(0,1fr)}',
	'.lanspeed-theme-aurora .lanspeed-warnings li{display:grid;grid-template-columns:minmax(0,1fr);gap:.25rem}',
	'.lanspeed-theme-aurora .lanspeed-warnings li .key{max-width:100%;word-break:break-all}}',
