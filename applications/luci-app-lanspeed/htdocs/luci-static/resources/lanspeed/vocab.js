...
var WARNING_LABELS = {
	...
	nss_daed_prefers_bpf: _('NSS 设备检测到 daed 运行中，已优先使用 BPF 采集 LAN 边缘客户端速率。'),
	nss_daed_nss_fallback_may_be_inaccurate: _('NSS 设备检测到 daed 运行中，但 BPF 不可用，已回退 NSS 采集；实时速率可能不准。'),
