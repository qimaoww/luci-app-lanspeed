...
var LAYOUT_CSS = [
	...
	'.lanspeed-theme-argon .lanspeed-caps{grid-template-columns:repeat(auto-fill,17rem);max-width:72rem;justify-content:start;gap:.5rem 1rem}',
	'.lanspeed-theme-argon .lanspeed-caps .cap{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:.65rem;padding:.18rem 0;min-width:0}',
