...
var LAYOUT_CSS = [
	...
	'.lanspeed-theme-argon .lanspeed-caps{grid-template-columns:repeat(auto-fill,14.25rem);max-width:61rem;justify-content:start;gap:.5rem 1rem}',
	'.lanspeed-theme-argon .lanspeed-caps .cap{display:grid;grid-template-columns:11rem 2.75rem;align-items:center;gap:.5rem;padding:.18rem 0;min-width:0}',
