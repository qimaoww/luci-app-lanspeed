...
var RESPONSIVE_CSS = [
	...
	'.lanspeed-clients-card .lanspeed-table[data-client-status="hidden"][data-client-totals="shown"] :is(th,td):is(:nth-child(2),:nth-child(3),:nth-child(4),:nth-child(5),:nth-child(6),:nth-child(10)){width:11.333333%;text-align:center}',
	...
	'.lanspeed-clients-card .lanspeed-table[data-client-status="shown"][data-client-totals="shown"] :is(th,td):is(:nth-child(2),:nth-child(3),:nth-child(4),:nth-child(5),:nth-child(6),:nth-child(9),:nth-child(10)){width:9.714285%;text-align:center}',
