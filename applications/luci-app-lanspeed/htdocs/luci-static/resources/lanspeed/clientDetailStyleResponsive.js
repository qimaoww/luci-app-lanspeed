...
var CSS = [
	...
	'.lanspeed-connections-card .lanspeed-table thead>tr{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.25em;padding:0 0 .6em;border-bottom:1px solid var(--border,rgba(128,128,128,.18))}',
