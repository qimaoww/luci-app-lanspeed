...
var CSS = [
	...
	'.lanspeed-connections-card .lanspeed-table tbody>tr{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.45em .75em;padding:.7em 0;border-bottom:1px solid var(--border,currentColor)}',
