...
var BOOTSTRAP_CSS = [
	...
	'.lanspeed-theme-bootstrap .lanspeed-metrics{grid-template-columns:repeat(4,minmax(0,1fr));',
	...
	'@media (max-width:1100px){.lanspeed-theme-bootstrap .lanspeed-metrics{grid-template-columns:repeat(2,minmax(0,1fr));gap:.55rem}',
