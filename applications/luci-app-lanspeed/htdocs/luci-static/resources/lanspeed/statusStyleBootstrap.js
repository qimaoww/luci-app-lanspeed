...
var BOOTSTRAP_CSS = [
	...
	'.lanspeed-theme-bootstrap .lanspeed-table tbody tr:hover,',
	'.lanspeed-theme-bootstrap .lanspeed-table tbody tr.lanspeed-client-hover-lock{background:var(--lanspeed-hover)}',
