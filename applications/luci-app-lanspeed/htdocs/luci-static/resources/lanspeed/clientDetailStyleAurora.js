...
var CSS = [
	...
	'.lanspeed-theme-aurora .lanspeed-connection-identity-card .lanspeed-header,.lanspeed-theme-aurora .lanspeed-connections-card .lanspeed-header{',
		'margin:0 0 var(--lanspeed-section-y);padding:0 0 var(--lanspeed-section-y);background:transparent;align-items:center}',
